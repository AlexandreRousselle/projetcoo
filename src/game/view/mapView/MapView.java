...
import javax.swing.JPanel;
	...
	public class MapView extends JPanel implements MouseMotionListener, MouseListener {
        ...
        private void createAssets() {
            ...
            GrassTile = gc.createCompatibleImage(128, 64, Transparency.TRANSLUCENT);
        ...
        private void drawGrassGrid(Graphics g) {
            ...
            for (int x = 0; x < tilecount; x++) {
                for (int y = 0; y < tilecount; y++) {
                    dx = x * GrassTile.getWidth() / 2 - y * GrassTile.getWidth() / 2;
                    dy = x * GrassTile.getHeight() / 2 + y * GrassTile.getHeight() / 2;
                    ...
                    g.drawString("(" + x + "," + y + ")", dx, dy + GrassTile.getHeight() / 2);
                }
            }
        }
