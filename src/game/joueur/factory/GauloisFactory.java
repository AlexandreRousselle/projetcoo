...
public class GauloisFactory {

	public Joueur creerJoueur(String nom_joueur, JoueurType joueur_type) {
		Joueur joueur = null;
		switch(joueur_type)
        {
            case JOUEURHUMAIN:joueur = new JoueurHumain(nom_joueur, JoueurTribu.GAULOIS);break;
            case JOUEURIA:joueur = new JoueurIA(nom_joueur, JoueurTribu.GAULOIS);break;
        }
		return joueur;
	}
