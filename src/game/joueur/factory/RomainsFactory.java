...
public class RomainsFactory {

	public Joueur creerJoueur(String nom_joueur, JoueurType joueur_type) {
		Joueur joueur = null;
		switch(joueur_type)
        {
            case JOUEURHUMAIN:joueur = new JoueurHumain(nom_joueur, JoueurTribu.ROMAINS);break;
            case JOUEURIA:joueur = new JoueurIA(nom_joueur, JoueurTribu.ROMAINS);break;
        }
		return joueur;
	}
